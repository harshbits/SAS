 ...
 */
@WebServlet(asyncSupported = true, urlPatterns = { "/DiscussionForumService" })
public class DiscussionForumService extends HttpServlet {
	...
	try {
			...
			request.setAttribute("topics", DiscussionForumDatabase.getDiscussionForumdetails());
			request.getRequestDispatcher("discussionForum.jsp").forward(request, response);
