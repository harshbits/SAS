...
<%@ page import="sas.data.storage.objects.Job" %>
...
<h4 style="text-align: center">Search Results</h4>
		...
		<% 
			queue = (Queue<Job>) request.getAttribute("results");
		...
		%>
				   ...
				   <div>
				         ...
				         <br/>
				         <label><%="Job function:" + job.getJob_function() %></label>
				         <br/> 
				   		<label><%="Experience:" + job.getExperience() %></label>
				         <br/> 		   		
				   		<label><%="Skill set:" + job.getSkill_set() %></label>
				   	     <br/> 
				   		<label><%="Employment type:" + job.getEmployement_type() %></label>
				   		<br/>		   		
				   		<label><%="Upload by : " + job.getPostedBy() %></label>
				   		<br/>
				   </div>
