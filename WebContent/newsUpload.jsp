		...
		if (session == null ||  session.getAttribute("user") == null) 
 		...
 		user = (User) session.getAttribute("user"); 
  	   	...
  	   	if (user.getCategory() != 2 && user.getCategory() != 3) {
  	   		...
  	   		request.getRequestDispatcher("NewsUploadService").forward(request, response);
  	   	}
...
<div class="art-block">
    <div class="art-block-body">
                ...
                <form name="myForm" action="NewsUploadService" method="post" enctype="multipart/form-data" onsubmit="return validateNewsUpload()">

		   Title: <br/><input type="text" id="title" name="title" style="size: 65"/><br/><br/>
		   Description: <br/><textarea id="newscontent" name="newscontent" style="size: 65" cols="65" rows="15"></textarea><br/><br/>
		   News Link: <br/><input type="text" id="newslink" name="newslink" style="size: 65"/><br/><br/>
		   News category: <br/><input type="text" id="category" name="category"style="size: 65"/><br/><br/>
