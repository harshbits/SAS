...
<div class="art-block">
    <div class="art-block-body">
                ...
                <form name="myForm" action="DiscussionForumAddService" method="post" onsubmit="return validatePostDiscussion()">
	
  Discussion Topic: <br><input type="text" id="title" name="title" style="size: 65"/><br><br>
  Discussion Description: <br><textarea id="description" name="description" style="size: 65" cols="65" rows="15"></textarea><br><br>
<input type="submit" name="Post" value="post" onclick="DiscussionForumAddService"/>
</form>
<div class="cleared"></div>
                    </div>
                </div>
