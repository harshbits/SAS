...
<div class="art-post">
<form name="mySearch" action="BookSearchService" method="post" onsubmit="return validateBookSearch()">
    <br/><input type="text" id="searchBook" name="searchBook" style="align: center; size: 35"/><br/><br/>
    <input type="submit" style="align: center" name="Search" value="Search" />
</form>
...
<div class="art-block">
    <div class="art-block-body">
                ...
                <form name="myForm" action="BookUploadService" method="post" enctype="multipart/form-data" onsubmit="return validateBookUpload()">
                <span>   	title: </span><br/><input type="text" name="title"/><br/><br/>
                <span>   category: </span><br/><input type="text" name="category"/><br/><br/>
                <span>   	author: </span><br/><input type="text" name="author"/><br/><br/>
                <span>   	edition: </span><br/><input type="text" name="edition"/><br/><br/>
                <span>   File: </span><br/><input type="file" name="file" /><br/><br/>
