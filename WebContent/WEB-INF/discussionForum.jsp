...
<div class="art-nav-inner">
	...
	<ul class="art-hmenu">
		...
		<li>
			<a href="./jobSearch.jsp"><span class="l"></span><span class="r"></span><span class="t">Job Search</span></a>
		</li>
		<li>
			<a href="./news.jsp"><span class="l"></span><span class="r"></span><span class="t">News</span></a>
		</li>
		<li>
        ...
        <div class="art-sheet-cc">
			<table style="width: 100%">
				...
				<tbody>
					...
					%>
					<tr>
						<td><%=discussionForum.getDateTime() %></td>
						<td><a href="discussionThread.jsp?=<%=discussionForum.getDiscussionId() %>"><%=discussionForum.getTitle() %></a></td>
